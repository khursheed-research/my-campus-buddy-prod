    ...
    <main className="min-h-screen p-8 max-w-2xl">
      ...
      <section className="mb-10">
        ...
        {!stats || stats.leaderboard.length === 0 ? (
          <p className="text-sm text-zinc-600">No contributions captured yet.</p>
        ) : (
            ...
            {stats.leaderboard.map((row, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 text-xs text-zinc-500">
                  ...
                  <span className="text-amber-500 font-medium">{row.score} pts</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section>
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            ...
            disabled={loading}
            className="text-xs rounded-md border border-zinc-600 text-zinc-300 px-3 py-1 disabled:opacity-50"
          >
        ...
        {report && (
          <div className="rounded-md border border-zinc-800 bg-zinc-900/50 px-4 py-4">
